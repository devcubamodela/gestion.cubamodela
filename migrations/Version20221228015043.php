 ...
 */
final class Version20221228015043 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE description description TEXT DEFAULT NULL, CHANGE short_description short_description TEXT DEFAULT NULL');
    }
}
